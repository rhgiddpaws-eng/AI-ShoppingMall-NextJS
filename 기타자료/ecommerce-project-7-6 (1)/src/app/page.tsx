      ...
      <main className="flex-1">
        ...
        <section className="relative">
          <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] w-full">
            ...
            <div className="absolute inset-0 bg-black/30 flex flex-col items-center justify-center text-white p-4">
              <h1 className="text-3xl md:text-5xl font-bold text-center mb-4">여름 컬렉션 출시</h1>
              <p className="text-lg md:text-xl text-center mb-6">최신 트렌드로 여름을 준비하세요</p>
        ...
        <section className="py-12 container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/category/men" className="group relative h-[180px] rounded-lg overflow-hidden">
              <Image
            ...
            <Link href="/category/women" className="group relative h-[180px] rounded-lg overflow-hidden">
              <Image
                src="/placeholder.svg?height=400&width=300"
                alt="여성"
                fill
            ...
            <Link href="/category/accessories" className="group relative h-[180px] rounded-lg overflow-hidden">
              <Image
                src="/placeholder.svg?height=400&width=300"
                alt="액세서리"
                fill
              ...
              />
              <div className="absolute inset-0 bg-black/40 group-hover:bg-black/50 transition-colors flex items-center justify-center">
                <span className="text-white text-xl font-semibold">액세서리</span>
              </div>
            </Link>
            <Link href="/category/shoes" className="group relative h-[180px] rounded-lg overflow-hidden">
              <Image
                src="/placeholder.svg?height=400&width=300"
                alt="신발"
                fill
        ...
        <section className="py-12 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">신규 회원 가입 시 10% 할인</h2>
            <p className="mb-6">지금 가입하고 첫 구매 시 10% 할인 혜택을 받아보세요.</p>
      ...
      <footer className="border-t py-8 bg-muted/50">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
            <p>&copy; {new Date().getFullYear()} ASOS Style. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
